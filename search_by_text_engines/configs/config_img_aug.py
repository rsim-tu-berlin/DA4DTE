...
parser.add_argument('--dataset', default='ucm', help='ucm or rsicd or vessel_dataset', type=str, metavar='DATASET_NAME')
...
parser.add_argument('--crop-size', default=[220, 220], nargs=2, type=int, metavar=('CROP_H', 'CROP_W'),
