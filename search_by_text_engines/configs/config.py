...
parser.add_argument('--preset', default='each_img_random', help='data presets, see available in config.py', type=str)
parser.add_argument('--alpha', default=0, help='alpha hyperparameter (La)', type=float) #0.01
parser.add_argument('--beta', default=0, help='beta hyperparameter (Lq)', type=float)
parser.add_argument('--gamma', default=0.001, help='gamma hyperparameter (Lbb)', type=float)
